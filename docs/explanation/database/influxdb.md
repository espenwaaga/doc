...
We discourage use of Aiven InfluxDB for new use cases, and don't offer support on Influxdb as software. Questions about Aiven and provisioning can be directed to [#nais](https://nav-it.slack.com/archives/C5KUST8N6) on Slack. For many use cases, the BigQuery alternative might be a better fit. For a description of [the BigQuery alternative](#suggested-alternative).

# Why we discourage use of Aiven InfluxDB
